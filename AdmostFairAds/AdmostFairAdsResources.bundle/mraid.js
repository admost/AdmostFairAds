 ...
 (function() {
   ...
   bridge.setIsVideoMuted = function(_isVideoMuted) {
    isVideoMuted = _isVideoMuted;
    broadcastEvent(EVENTS.INFO, 'Set isVideoMuted to ' + stringify(isVideoMuted));
  ...
  bridge.setOrientationDegree = function(_orientationDegree) {
   ...
   bridge.notifyVideoMutedChangeEvent = function() {
    broadcastEvent(EVENTS.INFO, 'Set isVideoMuted to ' + stringify(isVideoMuted));
    broadcastEvent(EVENTS.VIDEOMUTEDCHANGE, isVideoMuted);
  };
  ...
  bridge.notifyOrientationChangeEvent = function() {
   ...
   var changeHandlers = {
    ...
    orientationDegree: function(val) {
     ...
     broadcastEvent(EVENTS.INFO, 'Set orientationDegree to ' + stringify(val));
     broadcastEvent(EVENTS.ORIENTATIONCHANGE, orientationDegree);
   },
  ...
  mraid.orientationDegree = function() {
   ...
   mraid.complete = function() {
     bridge.executeNativeCall(['complete']);
   };
